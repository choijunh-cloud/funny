...
KOSPI_UNIVERSE: tuple[Stock, ...] = (
    ...
    _s(
        ...
        "WATCH",
        "방산",
        (16, 12, 18, 22, 54, 70, 20, 18, 2, 2),
        "문서4 헤지 버킷. 유가 경로가 끊긴 뒤 방산은 지수와 다른 현금흐름. "
        "Phase 1 기본 북에는 넣지 않고 v2 10종 북에서만 8%를 단다.",
    ),
    _s(
        "014830",
        "한솔케미칼",
    ...
    _s(
        ...
        "WATCH",
        "EPC/지주",
        (30, 36, 40, 70, 68, 90, 28, 36, 4, 2),
        "텍사스 가스복합 EPC와 스웨덴 1.2GW 원전 4기. 중동 재건 테마(삼성E&A)와 분리한다.",
    ),
    _s(
        "071050",
        "한국금융지주",
        ...
        "WATCH",
        "증권/IB",
        (18, 10, 22, 48, 88, 80, 70, 40, 2, 2),
        "낮은 PER·PBR에 이익이 늘어나는 금융. 반도체 팩터가 이미 큰 북의 분산용.",
    ),
    _s(
        "035420",
        "NAVER",
        ...
        "WATCH",
        "플랫폼/AI",
        (40, 30, 36, 28, 70, 92, 40, 30, 2, 2),
        "금리 안정 시 멀티플 확장. 지금 당장 이익 급증 종목이 아니라 인식 변화 종목.",
    ),
    _s(
        "012330",
        "현대모비스",
        ...
        "WATCH",
        "전장/A/S",
        (28, 22, 30, 32, 80, 88, 24, 28, 2, 2),
        "현대차 대신 담는 이유: A/S 현금흐름과 전장 옵션, 관세 직접 노출이 작다.",
    ),
    _s(
        "278470",
        "에이피알",
        ...
        "WATCH",
        "브랜드/디바이스",
        (14, 8, 12, 18, 36, 74, 10, 40, 2, 2),
        "성장은 콜마/코스맥스보다 강하나 밸류 부담이 크다. 기본 스윙 슬리브에는 넣지 않는다.",
    ),
    _s(
        "003230",
        "삼양식품",
        ...
        "WATCH",
        "음식료 수출",
        (8, 4, 10, 16, 38, 70, 12, 78, 2, 2),
        "원화 강세 시 곡물 원가 하락. 이미 멀티플이 높아 탑10 확률가중에서는 밀린다.",
    ),
    _s(
        "005180",
        "빙그레",
        ...
        "WATCH",
        "음식료",
        (6, 4, 8, 14, 50, 58, 10, 70, 2, 2),
        "삼양식품의 2선. 마진 스프레드는 같으나 유동성과 수출 레버리지가 작다.",
    ),
    _s(
        "005380",
        "현대차",

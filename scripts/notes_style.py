...
class Notes:
    def __init__(self, header="", footer="영상 녹화용 정리  ·  숫자·시나리오는 공개 코멘트 기준  ·  ", title="", subject="", author="준혁"):
        self.doc = Document()
        self._header = header
        self._footer = footer
        self._title = title
    ...
    def _setup(self):
        ...
        core.title = self._title
        core.author = self._author
        core.subject = self._subject

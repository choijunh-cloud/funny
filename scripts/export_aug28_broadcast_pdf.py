#!/usr/bin/env python3
"""Export the Aug 28 broadcast briefing to A4 PDF."""
...
HTML = ROOT / "reports" / "2026-08-28-broadcast-brief.html"
PDF = ROOT / "reports" / "2026-08-28-broadcast-brief.pdf"
SHARE = ROOT / "lectures" / "8월 28일 방송 코멘트 정리.pdf"
...
def main() -> None:
    ...
    profile = Path("/tmp/chrome-aug28-broadcast-pdf-profile")

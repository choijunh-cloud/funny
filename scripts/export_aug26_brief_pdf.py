#!/usr/bin/env python3
"""Export the Aug 26 briefing HTML to A4 PDF via Chrome headless."""
...
HTML = ROOT / "reports" / "2026-08-26-quick-comment-brief.html"
PDF = ROOT / "reports" / "2026-08-26-quick-comment-brief.pdf"
SHARE = ROOT / "lectures" / "8월 26일 Quick 코멘트 시각화.pdf"
...
def main() -> None:
    ...
    profile = Path("/tmp/chrome-brief-pdf-profile")

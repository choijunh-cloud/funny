#!/usr/bin/env python3
"""Export the Aug 28 briefing HTML to A4 PDF via Chrome headless."""
...
HTML = ROOT / "reports" / "2026-08-28-quick-comment-brief.html"
PDF = ROOT / "reports" / "2026-08-28-quick-comment-brief.pdf"
SHARE = ROOT / "lectures" / "8월 28일 Quick 코멘트 시각화.pdf"
...
def main() -> None:
    ...
    profile = Path("/tmp/chrome-aug28-brief-pdf-profile")
    ...
    try:
        subprocess.run(cmd, check=False, timeout=150)

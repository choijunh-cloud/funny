#!/usr/bin/env python3
"""Export the Aug 28 one-page core summary to A4 PDF."""
...
HTML = ROOT / "reports" / "2026-08-28-quick-comment-core.html"
PDF = ROOT / "reports" / "2026-08-28-quick-comment-core.pdf"
SHARE = ROOT / "lectures" / "8월 28일 Quick 코멘트 핵심요약.pdf"
...
def main() -> None:
    ...
    profile = Path("/tmp/chrome-aug28-core-pdf-profile")
